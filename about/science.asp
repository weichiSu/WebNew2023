      ...
      <div class="container-full pkAbout">
        ...
        <div class="swiper blbSwiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="pkAbout-mainBN" style="background: url(../images/science-1.png) #fff center no-repeat;">
                寶工科學玩具
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="pkAbout-txt text-center innerSpace">
            2017年寶工學習教育鏈再向下延伸，將專業工具 Pro’sKit (Professional Tool Kits) 延伸到益智科學的教育組件 Pro’sKit (Professional Science
            Kits)<br /><br />
          ...
          <div class="row proLine">
            <div class="col-xs-12 col-md-6 col-md-push-6 proLine-img">
              <img src="/images/about-2.png" alt="寶工專業工具" class="img-responsive" />
            </div>
            <div class="col-xs-12 col-md-6 col-md-pull-6 proLine-content">
              ...
              <div class="proLine-txt">
                第一次買科玩不知道該從何下手？別擔心，
                寶工科學玩具有適合各個年齡層的產品，最基礎入門產品點這邊。</div>
          ...
          <div class="row proLine">
            <div class="col-xs-12 col-md-6 proLine-img">
              <img src="/images/about-2.png" alt="得獎系列" class="img-responsive" />
            </div>
        ...
        <div class="pkAbout-bn">
          ...
          <div class="swiper blbSwiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="pkAbout-mainBN" style="background: url(../images/science-2.png) #fff center no-repeat;">
                  客製教學
                </div>
              </div>
            </div>
        ...
        <div class="container">
          ...
          <div class="pkAbout-txt text-center innerSpace">
            Founded in 1991, Pro’sKit was established in the heart of Xindian, New Taipei City, Taiwan. Started from
            designing professional tool kits, Pro’sKit later expanded into 22 categories while reaching a global market
