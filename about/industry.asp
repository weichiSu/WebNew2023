      ...
      <div class="container-full pkAbout">
        ...
        <div class="swiper blbSwiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="pkAbout-mainBN" style="background: url(../images/industry-1.png) #fff center no-repeat;">
                寶工專業工具
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="pkAbout-txt text-center innerSpace">
            創立於1991年於台北，Pro’sKit 寶工以設計專業工具組套起家，以多樣性的工具種類及優異的產品<br />品質聞名於業界。<br /><br />
        ...
        <div class="pkAbout-bn">
          ...
          <div class="swiper blbSwiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="pkAbout-mainBN" style="background: url(../images/industry-2.png) #fff center no-repeat;">
                  品質保證
                </div>
              </div>
            </div>
