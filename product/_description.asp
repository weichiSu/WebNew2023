<div class="col-xs-12 col-md-6 col-lg-5 col-lg-push-1 productDescription">
  ...
  <h1 itemprop="name" class="productDescription-name">
    四合一網路測試器(具USB測試) MT-7057N
  </h1>
  <div itemprop="material" class="productDescription-material">
    <img
      src="https://ref.prokits.com.tw/ProductPic/GE-617/1/201706201054310909.jpg"
      alt=""
      class="productDescription-material-img"
    />
    <img
      src="https://cdn.prokits.com.tw/images/PKWeb/logo/prokits-logo.png"
      alt=""
      class="productDescription-material-img"
    />
  </div>
  <h2 itemprop="positiveNotes" class="productDescription-positiveNotes">
    ☆ 100%台灣製造
    <br />☆ 創新專利設計 <br />☆ DIY模型機構設計 <br />☆
    紅外線感應+AI人工智慧=互動效果十足 <br />☆ 仿生傘蜥蜴，動作逼真逗趣 <br />☆
    親子動手做，關係更親密
  </h2>
  <div itemprop="keywords" class="productDescription-keywords">
  ...
  <div>
    <a
      itemprop="url"
      class="btn btn-pay btn-block btn-lg"
      href="/"
      data-toggle="modal"
    >
      立即購買<i class="icon-arrowBlack"></i
    ></a>
  </div>

  <div>
    <div class="productDescription-btnInfo">
      產品上架處理中，請洽02-2218-3233分機329 <br />
      取得更多資訊，謝謝！
    </div>
    <a
      itemprop="url"
      class="btn btn-keep btn-block btn-lg"
      href="#modal-container1"
      data-toggle="modal"
    >
      與寶工聯繫<i class="icon-arrow"></i
    ></a>
  </div>
